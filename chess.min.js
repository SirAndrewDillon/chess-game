(function() {
  ...
  function y(a, b) {
    b >>>= 0;
    31 < b
      ? ((a.b = (a.a << (b - 32)) >>> 0), (a.a = 0))
      : 0 < b &&
        ((a.b = ((a.b << b) | (a.a >>> (32 - b))) >>> 0),
        (a.a = (a.a << b) >>> 0));
    return a;
  }
  function z(a, b) {
  ...
  function la() {
    var a = ma;
    return A(
      D(270549120, 16909320).and(A(D(4294967295, 4294967295), 8 * a)),
      a
    );
  }
  function na() {
    var a = oa;
    return A(
      D(134480385, 2151686160).and(A(D(4294967295, 4294967295), 8 * -a)),
      a
    );
  }
  function pa() {
  ...
  for (
    var ta = D(4294967295, 4294967295),
      ua = D(1437226410, 1437226410),
      va = D(2857740885, 2857740885),
      wa = [],
      xa = 0;
    8 > xa;
    ++xa
  )
    wa.push(y(D(16843009, 16843009), xa));
  ...
  for (var Ea = [], Fa = 0; 1586 > Fa; ++Fa)
    Ea.push((1 + 4294967295 * Math.random()) >>> 0);
  function I(a, b) {
    a.b = (a.b ^ Ea[b]) >>> 0;
    a.a = (a.a ^ Ea[b + 1]) >>> 0;
  }
  ...
  function Ha() {
    ...
    for (var a = (this.h.length = 0); 64 > a; ++a) {
      var b;
      a: {
        for (b = 0; 5 >= b; ++b) if (!v(this.a[b], a)) break a;
        b = null;
      }
      this.h.push(b);
    }
  ...
  function Qa(a, b, d) {
    ...
    var c = d ? 1 : -1,
      f = 0 === b ? 4 : 60,
      e = Ka(a);
    (c = !v(e, f + c) || !v(e, f + 2 * c) || (!d && !v(e, f + 3 * c))) ||
      ((c = b ^ 1),
      (d = d ? 1 : -1),
      (b = 0 === b ? 4 : 60),
      (c = !(!La(a, c, b) && !La(a, c, b + d) && !La(a, c, b + 2 * d))));
    return c ? !1 : !0;
  }
  function Ra(a) {
    var b = a.b;
  ...
  function Ja(a, b) {
    ...
    c(C(Na).and(m), B, !0);
    0 <= a.f &&
      ((m = A(x(F(a.f + q).and(r), Ma), E)),
      d(m, E, 5),
      (q = A(x(F(a.f - q).and(r), T), B)),
      d(q, B, 5));
    q = ja(C(a.a[6 + h]));
    b && q.and(l);
    ...
    f(k, C(Ca[k]).and(q), 5);
    b ||
      (Qa(a, h, !0) && e.push(new L(k, k + 2, 2, 5, null)),
      Qa(a, h, !1) && e.push(new L(k, k - 2, 3, 5, null)));
    return e;
  }
  ...
  function X(a, b) {
    ...
    5 === O(b)
      ? (W(a, d, !0), W(a, d, !1))
      : 3 === O(b) &&
        (M(b) === R[d + 0] ? W(a, d, !0) : M(b) === R[d + 2] && W(a, d, !1));
    d ^= 1;
    3 === ((b.value >>> 19) & 7) &&
      (Ga(b) === R[d + 0] ? W(a, d, !0) : Ga(b) === R[d + 2] && W(a, d, !1));
  ...
  function cb(a) {
    ...
    function c(a, f, e, h) {
      ...
      for (
        var l = b(S(a, !0, !1)), k = 0 === a.c, m = !1, q = 0;
        q < l.length;
        ++q
      )
        if (X(a, l[q])) {
    ...
    for (
      var f = 0, e = null, h = -Infinity, l = Infinity, k = b(S(a, !0)), K = 0;
      K < k.length;
      ++K
    )
      if (X(a, k[K])) {
  ...
  function fb() {
    $('#chessboard table tr td, #chessboard table tr td div').removeClass(
  ...
  function hb(a) {
    ...
    $('#moves').html(
      '<a href="#" id="undo" class="' +
        (a.a.i.length ? 'can' : 'cannot') +
        '">undo</a><br/><a href="#" id="auto" class="' +
        (0 < b.length ? 'can' : 'cannot') +
        '">auto</a><br/>' +
        b
          .map(function(a, b) {
            return (
    ...
    var d = !1;
    $('#chessboard table tr td div.can-move')
      .mouseenter(function() {
        if (!d) {
          var c = $(this),
            f = c.parent(),
          ...
          f.hasClass('from') &&
            ...
            gb(),
            $('#chessboard table tr td.to').droppable({
              drop: function() {
  ...
  function ib(a) {
    ...
    b.fadeIn(function() {
      ...
      var f = d.offset().left - c.offset().left,
        ...
        h = c.children('div');
      h.css({ position: 'relative', top: '0px', left: '0px' });
      b.fadeOut(function() {
        h.animate({ top: e + 'px', left: f + 'px' }, function() {
          Z(a);
        });
      });
    });
  ...
  function Z(a) {
    ...
    $('#chessboard table tr td').removeClass(
      'white black turn last-move ' + aa.join(' ')
    );
    ...
    null !== b &&
      ($('#' + g(M(b))).addClass('last-move'),
      $('#' + g(b.value & 63)).addClass('last-move'));
    b = a.a;
    b = S(b).length
      ? 100 <= b.l
        ? 3
    ...
    0 === b && 1 === a.a.c
      ...
      : (hb(a),
        ...
        1 === b
          ? $('#moves').append('&#35;<br/>' + (a.a.c ? '1-0' : '0-1'))
          : 0 !== b && $('#moves').append('&frac12;-&frac12;'));
  }
