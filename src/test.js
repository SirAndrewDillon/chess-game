...
test('utilities', function() {
  ...
  strictEqual(
    Chess.getOtherPieceColor(Chess.PieceColor.WHITE),
    Chess.PieceColor.BLACK
  );
  strictEqual(
    Chess.getOtherPieceColor(Chess.PieceColor.BLACK),
...
test('Bitboard', function() {
  ...
  strictEqual(
    Chess.Bitboard.makeLightSquares()
      .xor(Chess.Bitboard.makeDarkSquares())
      .popcnt(),
    64
  );
  for (var k = 0; k < 8; ++k) {
...
test('Parser', function() {
  strictEqual(
    Chess.Parser.clean('A4   )(   (B- (C! ( ( D? ) ) E F)) G5'),
    'A4 G5'
  );
  ...
  strictEqual(
    chessPosition.getColorBitboard(Chess.PieceColor.BLACK).popcnt(),
    3
  );
  ok(chessPosition.getColorBitboard(Chess.PieceColor.BLACK).isSet(2));
  ok(
    chessPosition
      .getColorBitboard(Chess.PieceColor.BLACK)
      .isSet(Chess.getIndex(3, 3))
  );
  ok(
    chessPosition
      .getColorBitboard(Chess.PieceColor.BLACK)
      .isSet(Chess.getIndex(3, 4))
  );
  strictEqual(
    chessPosition.getColorBitboard(Chess.PieceColor.WHITE).popcnt(),
    3
  );
  ok(
    chessPosition
      .getColorBitboard(Chess.PieceColor.WHITE)
      .isSet(Chess.getIndex(1, 5))
  );
  ok(
    chessPosition
      .getColorBitboard(Chess.PieceColor.WHITE)
      .isSet(Chess.getIndex(5, 5))
  );
  ok(
    chessPosition
      .getColorBitboard(Chess.PieceColor.WHITE)
  ...
  strictEqual(
    chessPosition2.getColorBitboard(Chess.PieceColor.BLACK).popcnt(),
    14
  );
  strictEqual(
    chessPosition2.getColorBitboard(Chess.PieceColor.WHITE).popcnt(),
    14
  );
